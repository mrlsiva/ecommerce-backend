                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control d-none" id="category-id-input" name="category_id" value="<?php echo e($category[0]->id); ?>">
                                    <input type="text" class="form-control" name="name" id="category-title-input" value="<?php echo e($category[0]->name ?? null); ?>" placeholder="Enter category title" required>
                                    ...
                                    <div class="position-relative d-inline-block">
                                        ...
                                        <div class="avatar-lg">
                                            <div class="avatar-title bg-light rounded">
                                                <img src="<?php echo e($category[0]->media[0]->original_url); ?>" id="image-preview-thumb" class="preview-thumb avatar-md h-auto" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
			...
			<div class="col-lg-4">
                            ...
                            <select class="form-select" id="category_parent" name="category_parent">
								...
								<?php if(!empty($categories)): ?>
									<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										   <option value="<?php echo e($cate->id); ?>" <?php echo e(($category[0]->category_parent ?? '0') === $cate->id ? "selected":""); ?>><?php echo e($cate->name); ?></option>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                       ...
                       <input type="number" class="form-control" name="order" id="category-order-input" value="<?php echo e($category[0]->order ?? '0'); ?>" placeholder="Enter category order" required>
                    </div>
                    <!-- end card body -->
                </div>
                <!-- end card -->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravel\ecommerce-backend\resources\views/ecom/edit-category.blade.php ENDPATH**/ ?>