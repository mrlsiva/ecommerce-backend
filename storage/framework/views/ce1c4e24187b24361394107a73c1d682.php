...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        <!-- Dark Logo-->
        <a href="<?php echo e(route('show-products-page')); ?>" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('build/images/logo/logo.png')); ?>" alt="" height="30">
            </span>
            <span class="logo-lg">
                <img src="<?php echo e(URL::asset('build/images/logo/logo.png')); ?>" alt="" height="30">
            </span>
        ...
        <!-- Light Logo-->
        <a href="<?php echo e(route('show-products-page')); ?>" class="logo logo-light">
            <span class="logo-sm">
                <img src="<?php echo e(URL::asset('build/images/logo/logo.png')); ?>" alt="" height="30">
            </span>
            <span class="logo-lg">
            ...
            <ul class="navbar-nav" id="navbar-nav">
				...
				<li class="nav-item">
					...
					<div class="collapse menu-dropdown" id="sidebarEcommerce">
						<ul class="nav nav-sm flex-column">
							<li class="nav-item">
								<a href="<?php echo e(route('show-products-page')); ?>" class="nav-link">Products</a>
							</li>  
							<li class="nav-item">
								<a href="<?php echo e(route('show-categories')); ?>" class="nav-link">Categories</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a href="apps-ecommerce-seller-details" class="nav-link">sellers-details</a>
							</li>
						</ul>
					</div>
				</li>
...
<?php /**PATH D:\xampp\htdocs\laravel\krishnamadana-creative\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>